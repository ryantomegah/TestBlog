...
export const DATA = {
  ...
  description: "I'm Ryan Naum. I study why projects fail spectacularly and share what actually works. My background spans international economics, banking operations, compliance risk, and startups. We'll together watch why projects crash and burn from every angle imaginable. This blog-site will be breaking down famous project disasters, share practical frameworks that don't suck, and documents my own journey figuring out this whole project management thing. Whether you're running your first initiative or managing chaos across multiple teams, I'm here for it. My mission: Make project management feel less like corporate theater and more like a superpower. Let's build better stuff together.",
  summary: "Project management practitioner sharing failure analysis, practical frameworks, and lessons learned. From corporate disasters to startup chaos let's figure out what actually works.",
  avatarUrl: "/me.png",
  skills: {
  ...
  contact: {
    email: "ryantomegah@naum.ca",
    tel: "+1 438 855 0164",
    social: {
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/ryan-tomegah",
        icon: Icons.linkedin,
        navbar: true,
      },
      X: {
        name: "X",
        url: "https://x.com/ryan_naum",
        icon: Icons.x,
        navbar: true,
      },
      Youtube: {
        name: "Youtube",
        url: "https://www.youtube.com/@ryan_naum",
        icon: Icons.youtube,
        navbar: true,
      },
      email: {
        name: "Send Email",
        url: "mailto:ryantomegah@naum.ca",
        icon: Icons.email,
        navbar: false,
      },
    },
  ...
  work: [
    ...
    },
    {
      ...
      description: `
- Reconciled over 200 cross-border transactions weekly, managing CAD 40 million+ in monthly flow and ensuring 100% compliance with SWIFT, AML, and FX regulations.
- Built an Excel‑SQL enterprise Waterfall work-stream (requirements → UAT → rollout) that cut close cycle 80%, achieving 96% forecasting accuracy, enabling treasury to reduce FX exposure ‑15%.
- Designed senior‑management Power BI dashboards that cut financial close reporting from 2 days to 4 hours.
- Trained 3 junior officers on KYC/AML processes, decreasing processing errors ‑18%.
      `
    },
    {
      ...
      description: `
- Conducted remittance and trade finance analysis to support SME lending strategy; identified growth trends in West African corridors.
- Reviewed AML and KYC documentation for high-net-worth clients, improving due diligence workflows.
- Assisted with financial reporting process improvements by automating reconciliation templates in Excel.
      `
    },
  ],
  education: [
    ...
    },
    {
      ...
      href: "",
      degree: "Bachelors in International Economics",
      logoUrl: "/universite-lome.png",
      start: "2018",
      end: "2022",
      description: `
Specialization: International Trade and Financial Systems
Key Courses: Econometrics, Monetary Policy, International Finance, Global Development
GPA: 3.7/4.0
      `
    },
  ],
  projects: [
    ...
    {
      title: "NAUM Real Estate Marketing Agency",
      href: "",
      dates: "2024–Present",
      description: `
- Founded Naum Real Estate Marketing Agency as a solo consultant, delivering hyper‑local digital marketing for real‑estate professionals in Vancouver and Montréal.
- Execute paid‑ads, social content, and neighborhood outreach campaigns that generate qualified buyer and seller leads for clients.
